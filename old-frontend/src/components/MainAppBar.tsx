...
function UserInfo() {
  ...
  const handleChangeLongMode = (_event: React.MouseEvent<HTMLElement>, value: string) => {
...
export default function MainAppBar() {
  return (
    <>
      ...
      >
        <Stack sx={{width: '100%', height: '100%'}} direction="row" justifyContent="flex-end" alignItems="center">
          <UserInfo/>
        </Stack>
      </AppBar>
    </>

import {SocialMediaItem, SocialMediaScraperData, SocialMediaScrapeResult} from "../../common/types.ts";
  ...
  return (
    <Stack direction="row" spacing='16px' sx={{ boxSizing: 'border-box'}}>
      <img
        ...
        alt="?"
        style={{ width: 32, height: 32, borderRadius: '50%', border: 'solid 1px #bbb' }}
      />

      <Box sx={{ flex: 1 }}>
        <Box sx={{ wordBreak: 'break-all !important'}}>
          <Typography component="span" sx={{ color: 'black', fontSize: '14px', fontWeight: 'bold'}}>{props.comment.ownerUsername}</Typography>
          <Typography component="span" sx={{ color: 'black', fontSize: '14px', ml: '4px', wordBreak: 'normal' }}>{props.comment.text}</Typography>
        </Box>
        ...
        <Stack direction="row" sx={{ mt: '4px'}} spacing='12px'>
          ...
          <Typography sx={{ fontSize: '12px', fontWeight: 'bold', color: 'rgb(115, 115, 115)' }}>Reply</Typography>
        </Stack>
      </Box>
    </Stack>
  );
  ...
  return (
    <Stack
      sx={{
        ...
        borderRadius: '2px',
        fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif !important',
    ...
    >
      ...
      <Stack
        sx={{ width: '50%', flex: 1 }}
      >
        <Stack direction="row" sx={{ px: '16px', py: '14px', borderBottom: 'solid 1px #eee', overflow: 'hidden' }} spacing='16px'>
          <img
          ...
          <Stack sx={{ flex: 1 }}>
            <Stack direction="row" spacing={1} alignItems="center">
              <Typography sx={{ color: 'black', fontSize: '14px', fontWeight: 'bold'}}>{raw.main.ownerUsername}</Typography>
              <Typography sx={{ color: 'black'}}>•</Typography>
              <Typography sx={{ color: 'rgb(0, 149, 246)', fontSize: '14px', fontWeight: 'bold'}}>Follow</Typography>
            </Stack>
        ...
        <Box sx={{ flex: 1, position: 'relative', marginBottom: '5px' }}>
          <Stack sx={{ p: '16px', position: 'absolute', inset: 0, overflowY: 'auto' }} spacing='12px'>
        ...
        <Box sx={{ borderTop: 'solid 1px #eee', p: '16px', overflow: 'hidden'}}>
          <img
            src={buttonsImage}
            style={{ display: 'table', marginLeft: 'auto', marginRight: 'auto', marginBottom: '8px' }}
          />

          <Typography component="span" sx={{ color: 'black', fontSize: '14px', fontWeight: 'bold' }}>

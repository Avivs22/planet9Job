...
var Alert = React36.forwardRef(function Alert2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiAlert"
  });
...
var AlertTitle = React38.forwardRef(function AlertTitle2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiAlertTitle"
  });
...
var Portal = React40.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React40.isValidElement(children2) ? getReactElementRef(children2) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React40.isValidElement(children2)) {
      const newProps = {
        ref: handleRef
      };
      return React40.cloneElement(children2, newProps);
    }
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-TF6U635Q.js.map
